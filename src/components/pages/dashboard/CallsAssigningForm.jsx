...
const API = "https://nas-backend-7f28.onrender.com/api/v1/calls-assigning";
...
const CallsAssigningForm = () => {
  ...
  const fetchMasters = async () => {
    try {
      ...
      await Promise.all([
        fetchAndSet("https://nas-backend-7f28.onrender.com/api/v1/call-entry-form", setCalls),
        fetchAndSet("https://nas-backend-7f28.onrender.com/api/v1/department", setDepartments),
        fetchAndSet("https://nas-backend-7f28.onrender.com/api/v1/call-master", setCallTypes),
        (async () => {
          const res = await axios.get("https://nas-backend-7f28.onrender.com/api/v1/call-nature-master");
          const data = Array.isArray(res.data)
            ? res.data
            : Array.isArray(res.data.data)
              ? res.data.data
        ...
        fetchAndSet("https://nas-backend-7f28.onrender.com/api/v1/instrument-master", setInstruments),
        fetchAndSet("https://nas-backend-7f28.onrender.com/api/v1/problem", setProblems),
        fetchAndSet("https://nas-backend-7f28.onrender.com/api/v1/employee-master", setEmployees),
        // fetchAndSet("https://nas-backend-7f28.onrender.com/api/v1/status-master", setStatuses), // Removed status
        fetchAndSet("https://nas-backend-7f28.onrender.com/api/v1/call-urgency", setPriorities),
        fetchAndSet("https://nas-backend-7f28.onrender.com/api/v1/customer-master", setCustomers),
        fetchAndSet("https://nas-backend-7f28.onrender.com/api/v1/end-user-master", setEndUsers),
        fetchAndSet("https://nas-backend-7f28.onrender.com/api/v1/designation-master", setDesignations),
        // Fetch technician names for "Assigned By" from Technician Master
        (async () => {
          const res = await axios.get("https://nas-backend-7f28.onrender.com/api/v1/technician-master");
  ...
  const fetchCallEntryFormDetails = async (callNoId) => {
    ...
    try {
      const res = await axios.get(
        `https://nas-backend-7f28.onrender.com/api/v1/call-entry-form/${callNoId}`
      );
