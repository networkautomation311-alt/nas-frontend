...
const API =
  "https://networkautomation-in-234510.hostingersite.com/api/v1/end-user-master";
...
const DESIGNATION_API =
  "https://networkautomation-in-234510.hostingersite.com/api/v1/designation-master";
